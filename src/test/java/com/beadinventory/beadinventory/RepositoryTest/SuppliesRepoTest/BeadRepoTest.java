...
//    private Bead bead5;
    ...
    public void findBeadsByMaterialTest(){
        ...
        Bead bead3  = new Bead(STONE, ROUND,"tan",6,"ok",7,"with design cut into bead",0.05,
                "Bead Gallery");
        Bead bead4 = new Bead(AMETHYST, ROUND,"purple",6,"good",15,"translucent purple with some white",
                0.2,"Bead Gallery");
        Bead bead5 = new Bead(AMETHYST, ROUND,"purple",4,"poor",10,"translucent purple with some white",
                0.2,"Bead Gallery");
        ...
        Iterable<Bead> list = beadRepo.findBeadsByMaterial(AMETHYST);
