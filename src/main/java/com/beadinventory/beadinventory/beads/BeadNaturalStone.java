...
@Entity
public class BeadNaturalStone extends Bead {
    ...
    public BeadNaturalStone(Material material, String color, int sizeCM, Shape shape, String description, String quality, long quantity) {
