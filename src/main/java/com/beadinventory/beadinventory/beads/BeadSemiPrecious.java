...
@Entity
public class BeadSemiPrecious extends Bead {
    ...
    public BeadSemiPrecious(Material material, String color, int sizeCM, Shape shape, String description, String quality, long quantity) {
